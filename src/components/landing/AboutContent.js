    ...
    <div className="pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-background/70 max-w-2xl mx-auto leading-relaxed">
            Beltrust is a  banking platform built to showcase
            modern account management, transfers, cards, loans, and crypto —
            designed with the same care and attention to security that a
            production financial product would require.
          </p>
        </motion.div>
      </div>
    </div>
